...
const Reascii = ({ border, padding, color, background, fill }) => {
  ...
  const maxColumnWidth = borderWidth / 12;
  const canvasWidth = maxColumnWidth * 12;
  ...
  return (
    <>
    <GridCount color={bgColor} canvasWidth={canvasWidth} characterWidth={characterWidth} />
    <LineCountProvider>
      <div ref={parentContainerRef} style={{ backgroundColor: bgColor, outline: `1px solid transparent` }}>
        <div data-ascii={borderStyle.top.repeat(canvasWidth)}>{borderStyle.top.repeat(canvasWidth)}</div>
        <div>{".".repeat(canvasWidth)}</div>
        <Column id="1" fillChar="." cols={3} width={canvasWidth} characterWidth={characterWidth}>REASCII</Column>
        <Column id="2" fillChar="." cols={2} width={canvasWidth} characterWidth={characterWidth} color={textColor}>○ DAY</Column>
        <Column id="3" fillChar="." cols={2} width={canvasWidth} characterWidth={characterWidth} color={textColor}>○ FEATURED APIS</Column>
        <Column id="4" fillChar="." cols={2} width={canvasWidth} characterWidth={characterWidth} color={textColor}>○ ABOUT</Column>
        <Column id="5" fillChar="." cols={2} width={canvasWidth} characterWidth={characterWidth} color={textColor}>
          Testing this one with way more text than you should ever have
        </Column>
        <Column id="6" fillChar="." cols={1} width={canvasWidth} characterWidth={characterWidth} align='right'>{"{}"}</Column>
      </div>
    </LineCountProvider>
    <LineCountProvider>
      <div ref={parentContainerRef} style={{ backgroundColor: bgColor, outline: `1px solid transparent` }}>
        <Column id="1" fillChar="." cols={3} width={canvasWidth} characterWidth={characterWidth}>.</Column>
        <Column id="2" fillChar="." cols={2} width={canvasWidth} characterWidth={characterWidth} color={textColor}>● NIGHT</Column>
        <Column id="3" fillChar="." cols={2} width={canvasWidth} characterWidth={characterWidth} color={textColor}>○ ALL CATEGORIES</Column>
        <Column id="4" fillChar="." cols={2} width={canvasWidth} characterWidth={characterWidth} color={textColor}>.</Column>
        <Column id="5" fillChar="." cols={2} width={canvasWidth} characterWidth={characterWidth}>There were some interesting ideas here</Column>
        <Column id="6" fillChar="." cols={1} width={canvasWidth} characterWidth={characterWidth}>.</Column>
        <div>{".".repeat(canvasWidth)}</div>
        {borderStyle.bottom.repeat(canvasWidth)}
      </div>
    </LineCountProvider>
    <div style={{color: "#444"}}>
      <div>{".".repeat(canvasWidth)}</div>
    ...
    <LineCountProvider>
      <div ref={parentContainerRef} style={{ backgroundColor: bgColor, outline: `1px solid transparent` }}>
        <Column id="1" fillChar="." cols={3} width={canvasWidth} characterWidth={characterWidth}>Menu</Column>
        <Column id="2" fillChar="." cols={7} width={canvasWidth} characterWidth={characterWidth} color={textColor}>
